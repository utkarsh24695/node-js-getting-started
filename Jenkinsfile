    ...
    stages {
        ...
        stage('Snyk Test') {
            steps {
                ...
                snykSecurity organisation: 'utkarsh.sharma', projectName: 'node-js-getting-started', severity: 'medium', snykInstallation: 'mysnyk', snykTokenId: 'mysnyktoken', targetFile: 'package.json'
